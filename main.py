from tkinter import Tk, ttk, PhotoImage, RIDGE, Canvas, GROOVE, filedialog, Scale, HORIZONTAL, colorchooser, ROUND
import cv2
import numpy as np
...
class FrontEnd:
    ...
    def menu_initialisation(self):
        ...
        ttk.Label(self.frame_header, text="Upload, Edit and Save your images.").grid(row=1, column=1)
    ...
    # FUNCTIONS FOR FILTER MENU OPTIONS:
    # FILTERS:
    ...
    def horizontal_action(self):
        ...
        # FUNCTIONS FOR FOOTER MENU OPTIONS:
    ...
    def display_image(self, image=None):
        ...
        # If image is not passed, we will show the recent edited image:
        if image is None:
            image = self.edited_image.copy()
        else:
            image = image

        # Converting BGR color scheme to RGB fot tkinter to render the image:
        ...
        # If the image size is greater than the canvas, assigning new height and width:
        ...
        # Resizing the image to ne height:
